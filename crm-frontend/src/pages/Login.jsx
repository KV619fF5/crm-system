...
export default function Login({ setUser }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (isRegister && !validatePassword(password)) {
      showAlert("Password must be at least 8 characters long and contain letters and numbers.", "error");
      return;
    }
    ...
    try {
      ...
      console.error(err);
      showAlert(err.response?.data?.detail || "An error occurred. Check console.", "error");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="h-screen w-screen flex items-center justify-center 
      bg-gradient-to-br from-purple-800 via-purple-600 to-purple-800 relative">
